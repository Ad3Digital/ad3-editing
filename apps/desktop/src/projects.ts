...
An AD3 Editing project: a video composition authored as code. The folder is
...
- [JSX reference](https://github.com/Ad3Digital/ad3-editing/blob/main/reference/jsx/README.md): elements, timing, paints, generation, captions
- [CLI reference](https://github.com/Ad3Digital/ad3-editing/blob/main/reference/README.md): every command, its options and its output
- [Examples](https://github.com/Ad3Digital/ad3-editing/tree/main/examples): runnable compositions to read
`;
...
An AD3 Editing project: a video composition authored as code. The entry
...
export async function writeManifest(dir: string, manifest: unknown): Promise<void> {
  ...
  await writeFile(temp, `# AD3 Editing asset library. Edited by the app; hand edits are read on the next load.
${text}`, "utf8");
