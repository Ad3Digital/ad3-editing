...
Reports a bug in `dapi` itself or in AD3 Editing: a command that errors, contradicts this reference, or returns something it shouldn't. Bundles the description with diagnostics (dapi version, platform, node version, the app's recent console output) and files it as a GitHub issue on [Ad3Digital/ad3-editing](https://github.com/Ad3Digital/ad3-editing/issues), printing the URL of the created issue.
...
```ts
{
  url: string  // the created github.com/Ad3Digital/ad3-editing issue
}
```
